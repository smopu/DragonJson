...
{
    public unsafe class ChakeUnitTest
    {
        ...
        MyClass instens = null;
        [SetUp]
        public void Setup()
        {
            instens = (MyClass)warp.Create();
            instens.one = 1;
            instens.str = "S3ED";
        ...
        {
            MyClass instensT = new MyClass();
            ObjReference objReference = new ObjReference(instensT);
        ...
        {
            var instensT = (MyClass)warp.Create();
            Assert.IsTrue(typeof(MyClass) == instensT.GetType());
        }
        ...
        public void Test_FieldValue()
        {
            ...
            fixed (char* fieldNamePtr = fieldName)
            {
                ...
                *(int*)(*handleByte + addr.offset) = 18;
                ...
                object obj = addr.ClassGetValue(handleVoid);
                //不指定类型取值后 输出 18
                Assert.AreEqual(obj, 18);

                addr.ClassSetValue(handleVoid, 444);
                //不指定类型赋值后 输出 444
        ...
        public void Test_FieldClass()
        {
            ...
            fixed (char* fieldNamePtr = fieldName)
            {
                ...
                addr.ClassSetValue(handleVoid, "DDcc#2$%@");
                //不指定类型赋值后 输出 DDcc#2$%@
        ...
        public void Test_FieldStruct()
        {
            ...
            fixed (char* fieldNamePtr = fieldName)
            {
                ...
                Vector3 value = addr.ClassReadStruct<Vector3>(handleVoid);
                //取值后 输出 3, -4.5, 97.4
                Assert.IsTrue(value == new Vector3(3, -4.5f, 97.4f));

                var pt = new Vector3(-99.56f, 50.22f, 9f);
                addr.ClassWriteStruct<Vector3>(handleVoid, pt);
                ...
                addr.ClassSetValue(handleVoid, new Vector3(0, -9999f, 12.888f));
        ...
        public void Test_PropertyClass()
        {
            ...
            fixed (char* fieldNamePtr = fieldName)
            {
                ...
                string value = addr.propertyDelegateItem.getObjectString(instens);
                //取值后 输出 QBN3
        ...
        public void Test_PropertyStruct()
        {
            ...
            fixed (char* fieldNamePtr = fieldName)
            {
                ...
                addr.ClassSetValue(handleVoid, new Vector3(12.888f, -9999f, 0));
                //不指定类型赋值后 输出 0, -9999 , 12.888
        ...
        public void Test_FieldArrayValue()
        {
            ...
            fixed (char* fieldNamePtr = fieldName)
            {
                ...
                Array array = (Array)addr.ClassGetValue(handleVoid);
