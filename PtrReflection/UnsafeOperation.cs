...
        public unsafe static IntPtr GetObjectAddr(TypedReference tf)
        ...
        public unsafe static int SizeOfStack(Type type)
        {
            ...
            {
                return UnsafeOperation.PTR_COUNT;
        ...
        public unsafe static IntPtr GetTypeHead(Type type)
        {
            if (type.IsArray)
            {
                ...
                {
                    value = allTypeHead[type] = *(IntPtr*)GeneralTool.ObjectToVoidPtr(
            ...
            else
            {
                ...
                //IntPtr value = allTypeHead[type] = *(IntPtr*)GeneralTool.ObjectToVoidPtr(v);
                //return value;
...
        public unsafe static void UnsafeSetObject(void* tar, object obj)
        ...
        static PtrReflection.StringToType stringToType = new StringToType(dictionaryGetType);
